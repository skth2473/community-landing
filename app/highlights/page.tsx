  ...
  const events = [
    {
      ...
      description: "The inaugural event of our Engineering Community, featuring keynote speakers from leading tech companies and interactive sessions on emerging technologies.",
    ...
    },
    {
      ...
      description: "A comprehensive bootcamp to prepare students for the Smart India Hackathon, covering ideation, prototyping, and presentation skills.",
      image: "/placeholder.svg?height=400&width=600",
      attendees: 120,
      highlights: [
    ...
    },
    {
      ...
      description: "A day-long celebration honoring the contributions of engineers to society, featuring project exhibitions, technical competitions, and cultural performances.",
      image: "/placeholder.svg?height=400&width=600",
      attendees: 350,
      highlights: [
    ...
    },
    {
      ...
      description: "An intensive workshop on building applications on the Aptos blockchain, covering fundamentals, smart contracts, and decentralized application development.",
      image: "/aptos.jpg",
      attendees: 80,
      highlights: [
    ...
    },
    {
      ...
      description: "A networking event designed to connect community members, recognize volunteers, and distribute certificates for their contributions to various community initiatives.",
      image: "/placeholder.svg?height=400&width=600",
      attendees: 150,
      highlights: [
    ...
    },
    {
      ...
      description: "A comprehensive workshop series on artificial intelligence and machine learning, covering fundamental concepts, algorithms, and practical applications in various domains.",
      image: "/placeholder.svg?height=400&width=600",
      attendees: 100,
      highlights: [
